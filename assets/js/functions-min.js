...
$e.Hammer=lt,"function"==typeof define&&define.amd?define(function(){return lt}):"undefined"!=typeof module&&module.exports?module.exports=lt:t[i]=lt}(window,document,"Hammer"),$(document).ready(function(){function t(t){var n=$(".side-nav").find(".is-active"),s=$(".side-nav").children().index(n),r=$(".side-nav").children().length-1,o=0;
...
e(r),i(s,r,o)}}),$(".cta").click(function(){
    var t=$(".side-nav").find(".is-active"),n=$(".side-nav").children().index(t),s=$(".side-nav").children().length-4,r=s; //add or subtract from length to change button action
    e(s),i(n,r,s)});
var l=document.getElementById("viewport"),c=new Hammer(l);c.get("swipe").set({direction:Hammer.DIRECTION_VERTICAL}),c.on("swipeup swipedown",function(e){t(e)}),$(document).keyup(function(e){$(".outer-nav").hasClass("is-vis")||(e.preventDefault(),t(e))}),n(),s(),r()});
...
Open.addEventListener('click', () => {
  ...
  $( '.work--lockup' ).addClass( 'blur' );
  $( '.page2title' ).addClass( 'blur' );
});
